...
| 10 | [10-voyage-experience-plan.md](docs/10-voyage-experience-plan.md) | 航海體驗強化計畫（M11–M14）：風向、鍵盤操舵、港口過場、天氣視覺（已全數完成） | 實作 AI / 開發者 |
| 11 | [11-art-direction.md](docs/11-art-direction.md) | 美術方向計畫（M15–M17）：版權紅線、風格規範、資產清單與生圖 prompt、資產管線 | 所有人 |
